    ...
    <div className='mt-20 md:mt-20 lg:mt-28 px-1 sm:px-10 md:px-15 lg:px-24 min-h-screen'>
                    ...
                    <div className='flex justify-between items-center border-yellow border-2 rounded-lg p-5 '>
                        <div className="flex items-center gap-x-5">
                            ...
                            <div className="">
                                ...
                                <h1>sombrereriadesandoval@gmail.com</h1>
                            </div>
                        </div>
                        <div className="">
        ...
        <div className="bg-white p-10 rounded-lg shadow-md">
            <div className="flex items-center gap-x-2 justify-center text-text font-semibold">
                <div className={`${Status === "Pending" ? "text-primary" : "text-text"}`}>
                    Pending
                </div>
                <div className="bg-text w-10 h-1 rounded-md"></div>
                <div className={`${Status === "Confirmed" ? "text-primary" : "text-text"}`}>
                    Confirmed
                </div>
                <div className="bg-text w-10 h-1 rounded-md"></div>
                <div className={`${Status === "Out for Delivery" ? "text-primary" : "text-text"}`}>
                    Out for delivery
                </div>
                <div className="bg-text w-10 h-1 rounded-md"></div>
                <div className={`${Status === "Completed" ? "text-primary" : "text-text"}`}>
                    Completed
                </div>
                <div className="bg-text w-10 h-1 rounded-md"></div>
                <div className={`${Status === "Cancelled" ? "text-primary" : "text-text"}`}>
                    Cancelled
                </div>
            </div>
            <div className="">
