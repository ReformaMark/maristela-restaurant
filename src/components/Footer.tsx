...
function Footer() {
  return (
    <footer className='w-full min-h-40 border-t-2 bg-gray-100 border-t-gray-100 px-24 py-10'>
      <div className="flex justify-between items-center border-b-2 border-b-yellow pb-5">
        <div className="flex items-center gap-x-5">
          <Image src={Logo} alt='Logo' className='size-20 object-cover'/>
          <h1 className='text-primary font-bold text-xl font-parisienne'>Maristela&apos;s Restaurant</h1>
        </div>
