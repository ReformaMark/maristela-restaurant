    ...
    >
      <PopoverTrigger asChild>
        <Button size={'lg'} variant="outline" className="w-full md:w-auto">
          <div className="text-right">
            <div className="py-1">
              <div className="text-sm md:text-base">{`${formatDate(range.from, locale)}${
      ...
      <PopoverContent align={align} className="w-screen md:w-auto max-w-screen-lg p-0 md:p-4">
        <div className="flex flex-col md:flex-row p-2 md:p-4">
            ...
            <div className="flex flex-col gap-2 px-2 md:px-3 pb-4">
              {showCompare && (
                <div className="flex items-center space-x-2 pr-4 py-1">
                  {/* Compare switch removed as per original */}
                </div>
              )}
          ...
          {!isSmallScreen && (
            <div className="hidden md:flex flex-col items-end gap-1 pl-6 min-w-[150px]">
              {PRESETS.map((preset) => (
                <PresetButton
                  key={preset.name}
                  preset={preset.name}
